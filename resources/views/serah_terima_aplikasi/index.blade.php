...
<script>
    ...
    function editForm(url) {
        $('#modal-form').modal('show');
        $('#modal-form .modal-title').text('Edit Berita Acara Serah Terima Aplikasi');
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-form [name=nik_pemberi]').val(response.nik_pemberi);
                $('#modal-form [name=nik_penerima]').val(response.nik_penerima);
            })
            .fail((errors) => {
