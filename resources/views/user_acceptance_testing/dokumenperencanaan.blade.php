    ...
    <table>
        <tr>
            ...
            <td rowspan="4" class="text-center">
                <h2>Perencanaan User Acceptance Testing (UAT)</h2>
            </td>
            <td>No. Dokumen</td>
            <td>FP-DTI03-F</td>
        </tr>
...
<h3 class="text-center bold">PERENCANAAN USER ACCEPTANCE TESTING (UAT)</h3>
<h4 class="text-right"><strong>NO: {{ $useracceptancetesting->first()->nomor_proyek }}</strong></h4>
<table>
    <tr>
        <td>Nama Aplikasi</td>
    ...
    <tr>
        ...
        <td>{{ $useracceptancetesting->jenis_aplikasi }}</td>
    </tr>
    <tr>
        <td>Kebutuhan Fungsional</td>
        <td>{{ $useracceptancetesting->kebutuhan_nonfungsional }}</td>
    </tr>
    <tr>
