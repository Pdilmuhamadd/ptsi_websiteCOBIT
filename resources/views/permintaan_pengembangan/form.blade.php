            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="latar_belakang" id="latar_belakang" class="form-control" required autofocus placeholder="Latar Belakang atau Deskripsi Proyek"></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="tujuan" id="tujuan" class="form-control" required autofocus placeholder="Tujuan Proyek"></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="fungsi_sistem_informasi" id="fungsi_sistem_informasi" class="form-control" required autofocus placeholder="Fungsi Sistem Informasi"></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <textarea name="uraian_permintaan_tambahan" id="uraian_permintaan_tambahan" class="form-control" required autofocus placeholder="Permintaan Tambahan"></textarea>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="nama_pemohon" id="nama_pemohon" class="form-control" required autofocus placeholder="Masukkan Nama Pemohon">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
